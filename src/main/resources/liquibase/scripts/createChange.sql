...
'Привет. Я помогаю приютам для бездомных животных пристроить их питомцев. Выберите приют.',
'Приветсвие', 1);
...
insert into answer (id, category, texts, title, shelter_id)
values(5, 'INFORMATION', 'Мы свяжемся с Вами, оставьте, пожалуйста, номер телефона',
'Контактные данные для связи', 1);

insert into answer (id, category, texts, title, shelter_id)
values(6, 'INFORMATION', 'Позвать волонтера', 'Позвать волонтера', 1);

insert into answer (id, category, texts, title, shelter_id)
values (7, 'INFORMATION', 'Привет.
Я помогаю приютам для бездомных животных пристроить их питомцев. Выберите приют.',
'Приветсвие', 2);
...
insert into answer (id, category, texts, title, shelter_id)
values(11, 'INFORMATION', 'Мы свяжемся с Вами, оставьте, пожалуйста, номер телефона',
'Контактные данные для связи', 2);

insert into answer (id, category, texts, title, shelter_id)
values(12, 'INFORMATION', 'Позвать волонтера', 'Позвать волонтера', 2);

insert into answer (id, category, texts, title, shelter_id)
values(13, 'GETTING_ANIMAL', 'Привет, дорогой усыновитель!', 'Приветствие', 1);
...
insert into answer (id, category, texts, title, shelter_id)
values(21, 'GETTING_ANIMAL', 'Оставьте номер телефона для связи',
'Контактные данные для связи', 1);

insert into answer (id, category, texts, title, shelter_id)
values(22, 'GETTING_ANIMAL', 'Позвать волонтера',
'Позвать волонтера', 1);

insert into answer (id, category, texts, title, shelter_id)
values(23, 'GETTING_ANIMAL', 'Привет, дорогой усыновитель!', 'Приветствие', 2);
...
insert into answer (id, category, texts, title, shelter_id)
values(31, 'GETTING_ANIMAL', 'Оставьте номер телефона для связи',
'Контактные данные для связи', 2);

insert into answer (id, category, texts, title, shelter_id)
values(32, 'GETTING_ANIMAL', 'Позвать волонтера',
'Позвать волонтера', 2);
